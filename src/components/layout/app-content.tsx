...
const FULL_BLEED_PATHS = ['/sign-in', '/sign-up', '/onboarding', '/onboarding-flow-lab', '/workflow-lab', '/observation-lab', '/cohort-lab', '/dashboard-lab', '/experiments-lab', '/experiment-detail-lab'];
